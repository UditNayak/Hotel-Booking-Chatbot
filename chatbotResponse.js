...
const function_descriptions = [
  ...
  },
  {
    name: "createBooking",
    description:
      "creates a booking of the room after user has given all the parameters",
    parameters: {
      type: "object",
      properties: {
        roomId: {
...
async function createBooking({ roomId, fullName, email, nights }) {
  ...
  try {
    ...
    return `Booking successful. Your booking ID is: ${response.data.bookingId} and total cost is: ${response.data.totalPrice}`;
  } catch (error) {
